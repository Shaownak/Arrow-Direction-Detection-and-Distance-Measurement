    ...
    for cnt in contours:
        ...
        if area > 5000:
            ...
            if(len(approx) == 7):
                ...
                cv2.line(outImg, (30, 30), (230, 30), (0,0,255), 32)
                cv2.line(outImg, (30, 30), (230, 30), (0,0,0), 28)

                # Drawing Text on the screen
                cv2.putText(
                    outImg, f"Distance: {round(Distance,2)} CM", (30, 35),
...
# def distance(image):
    # Get the image, and measure the distance to the object in the image
